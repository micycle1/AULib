...
public class AUCamera {
	...
	public void setNumExposures(int _numExposures) {
		numExposures = _numExposures;
	}

	public void setAutoNormalize(boolean _autoNormalize255) {
		autoNormalize255 = _autoNormalize255;
	}
	...
	public void setAutoExit(boolean _autoExit) {
		autoExit = _autoExit;
	}

	public void setSaveFormat(String _saveFormat) {
	...
	public void setRampTime(float _rampTime) {
		rampTime = _rampTime;
	}
	...
	public void setShutterType(int _shutterType) {
		shutterType = _shutterType;
	}

	public void setTimeWrap(boolean _timeWrap) {
		timeWrap = _timeWrap;
	}

	public void setPDFmode(boolean _PDFmode) {
		PDFmode = _PDFmode;
	}
	...
	public void setSize(int wid, int hgt) {
		...
		if ((theSketch.width != imageWidth) || (theSketch.height != imageHeight)) {
			screenPImage = theSketch.createImage(theSketch.width, theSketch.height, PConstants.RGB);
	...
	// given where we are in the exposure, find how much to weight this image's
	// contribution
...
//			pdf.nextPage();
			...
			if (((theSketch.width != imageWidth) || (theSketch.height != imageHeight)) && (screenPImage != null)
					&& (resizedScreenPG != null)) {
				// save just the upper-left imageWidth-by-imageHeight rectangle of the graphics
				// window
