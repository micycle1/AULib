...
/*************************************************
 * PROCESSING REPLACEMENTS Some of Processing's handy math and color functions.
 * These are mostly for debugging and while writing code. In particular, the
 * color functions should always be replaced with in-line code for efficiency
 * reasons.
 *************************************************/
...
public class AUMisc implements PConstants {
	...
	/*
	 * Take apart and assemble colors. Note when assembling that the alpha value is
	 * 0xFF (format in the int is ARGB).
	 */
