...
public class AUGlob implements PConstants {
	...
	public AUGlob(PApplet _theSketch, PVector _C0, float _r0, PVector _C1, float _r1, PVector _D, float _a, float _b, PVector _Dp,
			float _ap, float _bp) {
	...
	public AUGlob(PApplet _theSketch, PVector _C0, float _r0, PVector _C1, float _r1, float _dpar, float _dperp, float _a, float _b,
			float _dppar, float _dpperp, float _ap, float _bp) {
		theSketch = _theSketch;
		C0 = _C0.get();
		C1 = _C1.get();
		r0 = _r0;
	...
	/*
	 * This is the heart of the algorithm. Find vectors U and V to establish a
	 * coordinate system. Then find points E on the circles that form the tangent
	 * line with D, choosing the proper side. Using a and b (and a' (ap) and b'
	 * (bp)) find points F on the lines from E to D. The Bezier curve is formed with
	 * two E points as ends and two F points as controls.
	 */
